...
class LinterConfig:
    ...
    def default(cls) -> "LinterConfig":
        ...
        return cls(
            rules={
                ...
                "copilot-frontmatter-valid": {"enabled": "auto", "severity": "warning"},
                "copilot-apply-to-valid": {"enabled": "auto", "severity": "warning"},
                "copilot-code-review-truncation": {"enabled": "auto", "severity": "warning"},
                "copilot-instruction-hierarchy": {"enabled": "auto", "severity": "warning"},
                "copilot-dead-file-refs": {"enabled": "auto", "severity": "warning"},
                "copilot-dead-command-refs": {"enabled": "auto", "severity": "warning"},
                "copilot-weak-language": {"enabled": "auto", "severity": "info"},
                "copilot-size-limit": {"enabled": "auto", "severity": "info"},
                "copilot-tautological": {"enabled": "auto", "severity": "info"},
                "copilot-critical-position": {"enabled": "auto", "severity": "info"},
    ...
    _INIT_OVERRIDES: ClassVar[Dict[str, Dict[str, Any]]] = {
        ...
        "copilot-frontmatter-valid": {"enabled": True},
        "copilot-apply-to-valid": {"enabled": True},
        "copilot-code-review-truncation": {"enabled": True},
        "copilot-instruction-hierarchy": {"enabled": True},
        "copilot-dead-file-refs": {"enabled": True},
        "copilot-dead-command-refs": {"enabled": True},
        "copilot-weak-language": {"enabled": True},
        "copilot-size-limit": {"enabled": True},
        "copilot-tautological": {"enabled": True},
        "copilot-critical-position": {"enabled": True},
