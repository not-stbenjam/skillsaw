...
| **Autofix** | - |
| **Since** | v0.15.0 |
| **Repo Types** | agent-plugin, agentskills, antigravity-plugin, codex-marketplace, codex-plugin, cursor-marketplace, cursor-plugin, dot-claude, grok-marketplace, grok-plugin, marketplace, pi, pi-package, single-plugin |
