...
| **Autofix** | - |
| **Since** | v0.1.0 |
| **Repo Types** | agent-plugin, agentskills, antigravity-plugin, codex-marketplace, codex-plugin, cursor-marketplace, cursor-plugin, dot-claude, grok-marketplace, grok-plugin, marketplace, single-plugin |
