...
flaws, and content dead zones with 104 rules, then applies deterministic
autofixes.
</p>
...
-   :package:{ .lg .middle } **Multi-Ecosystem Structure**
    ...
    Claude Code, OpenAI Codex, Grok Build, Google Antigravity, Agent Plugins v1, Copilot custom agents, OpenCode, Muse Code, Pi, APM, and MCP Registry.
